                    ...
                    child: Container(
                      ...
                      children: <Widget>[
                        ...
                        /* ListTile(
                          ...
                          title: Text('Settings')), */
                        ListTile(
                            leading: Icon(Icons.favorite), title: Text('Authors: Win & Amy')
                        ),
                        ListTile(
                            leading: Icon(Icons.description), title: Text('LGPL-2.1 license')
                        ),
                        ListTile(
                            leading: Icon(Icons.info), title: Text('Version: alpha-0.0.1')
                        )
                      ],
                    ))))
          ],
